...
\begin{figure}[!htb]
\centering
\subfigure[]{\label{fig:tt-mtop8TeV_a}\includegraphics[width=0.45\textwidth]{\cheight/mwh-top-thesis.pdf}}\\
\subfigure[]{\label{fig:tt-mtop8TeV_b}\includegraphics[width=0.45\textwidth]{\cheight/lept-top-mass-thesis.pdf}}
\subfigure[]{\label{fig:tt-mtop8TeV_c}\includegraphics[width=0.45\textwidth]{\cheight/hadr-top-mass-thesis.pdf}}
