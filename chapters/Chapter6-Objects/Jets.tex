...
\begin{figure}[!htb]
 \begin{center}
  \includegraphics[width=0.5\textwidth]{\chsix/btagalgo-ak4jets.pdf}
 \end{center}
...
\begin{figure}[!htb]
\begin{center}
\subfigure[]{\label{fig:btag_sfb_a}\includegraphics[width=0.49\textwidth]{\chsix/btag-sfb-pt-csvm-run1.pdf}}
\subfigure[]{\label{fig:btag_sfb_b}\includegraphics[width=0.49\textwidth]{\chsix/btag-sfb-pt-csvv2m-run2.pdf}}
\end{center} 
...
\begin{figure}[!htb]
\begin{center}
\subfigure[]{\label{fig:btag_sfl_a}\includegraphics[width=0.49\textwidth]{\chsix/btag-SFlight-csvm-run1.pdf}}
\subfigure[]{\label{fig:btag_sfl_b}\includegraphics[width=0.49\textwidth]{\chsix/btag-SFlight-csvv2m-run2.pdf}}
\end{center} 
