...
In general, muons will not be absorbed by the calorimeters, as it happens with electrons, so a specific muon detection system (Section~\ref{subsec:muonchambers}) is needed in order to identify and correctly measure their momenta.\\
