...
\usepackage[hyperindex=true,pdftitle={Search for diboson resonances with CMS and Pixel Barrel Detector  Calibration and Upgrade},pdfauthor={Jennifer Ngadiuba},colorlinks=false,pagebackref=false,citecolor=blue,plainpages=false,pdfpagelabels]{hyperref} % colourlinks=false for printing 
