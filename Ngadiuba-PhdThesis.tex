...
\usepackage[hyperindex=true,pdftitle={Search for diboson resonances with CMS and Optimization and Upgrade of the CMS Pixel Barrel Detector},pdfauthor={Jennifer Ngadiuba},colorlinks=false,pagebackref=false,citecolor=blue,plainpages=false,pdfpagelabels]{hyperref} % colourlinks=false for printing 
