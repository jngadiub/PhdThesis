...
The calibrations are performed with POS which was as well installed and run on the computers available in the clean room.
...
%\includegraphics[width=0.45\textwidth]{\chfifteen/TimeWalk_vs_Vana.png}
 %\end{center}
 %\caption{Evolution of the DT, defined as difference between the in-time and absolute thresholds of the pixels on a ROC as a function the change in \textit{Vana} applied in the FPix \textit{Vana} calibration. As \textit{Vana} was increased (decreased), the DT decreased (increased) due to the change in time-walk~\cite{Kreis:2011zw}.}
 %\label{fig:Timewalk}
%\end{figure}
