...
\begin{figure}[!htb]
 \begin{center}
  %\subfigure[]{\label{fig:partonLumiRatio_a}\includegraphics[width=0.25\textwidth]{\chthree/lumiTevLHC714.pdf}}
  %\subfigure[]{\label{fig:partonLumiRatio_b}\includegraphics[width=0.46\textwidth]{\chthree/lhclumi7813_2013_v1.pdf}}
...
\begin{figure}[!htb]
 \begin{center}
 \subfigure[]{\label{fig:LHClumiAndPU_a}\includegraphics[width=0.48\textwidth]{\chthree/pileup_pp_2012.png}}
