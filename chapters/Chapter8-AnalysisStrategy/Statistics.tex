...
In order to quote, as conventionally done, 95\% C.L. observed upper limits, the full procedure is iterated for different values of $\mu$, until $\mathrm{CL}_s = 0.05$ is found.
