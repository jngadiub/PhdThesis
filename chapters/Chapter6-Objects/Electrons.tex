...
Specifically, the total scalar sum of the \pt all the tracks in a cone of radius $\Delta R = 0.3$ around the electron direction, excluding tracks within an inner cone of $\Delta R = 0.04$ to remove the contribution from the electron itself, is required to be less than 5\GeV.
