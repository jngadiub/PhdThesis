...
\subfigure[]{\label{fig:pu_mc_data_b}\includegraphics[width=0.44\textwidth]{\chfive/c_nPVs_8TeV.pdf}}
\subfigure[]{\label{fig:pu_mc_data_d}\includegraphics[width=0.45\textwidth]{\chfive/c_nPVs.pdf}}
...
All the samples are then processed further by \PYTHIA{6}, using the Z2* tune, for simulation of parton showering and subsequent hadronization. %and for simulation of the underlying event.
