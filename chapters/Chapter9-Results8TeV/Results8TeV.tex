...
\subfigure[]{\label{fig:mWH-final_b}\includegraphics[width=0.45\textwidth]{\chnine/signal-region-el.pdf}}
\caption{
...
\begin{figure}[htb]
\centering
     \includegraphics[width=0.49\textwidth]{\chnine/pvalue_combo.pdf}
\caption{
...
\begin{figure}[htb]
\centering
     \includegraphics[width=0.49\textwidth]{\chnine/global-vs-local-significance-M800-2500-combo.pdf}
\caption{
...
\FIXME{point to theory with widths, xsec, model parameters etc.}
...
Figure~\ref{fig:limitsFullCLS-WH} shows the expected and observed exclusion limits at 95\% CL on the product of the $\Wpr$ production cross section and the branching fraction of $\Wpr\rightarrow$WH for the
